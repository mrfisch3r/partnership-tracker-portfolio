  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        "http://localhost:5001/api/add_potential_partner",
        {
          method: "POST",
          headers: {
    ...
    <div className="add-partner-form">
      ...
      <div className="form-instructions">
        ...
        <ul>
          ...
          <li>
            <strong>Contact Date:</strong> Include method and date (e.g.,
            "Email: MM/DD/YYYY")
          </li>
        </ul>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          />
          <small className="field-hint">
            Format as "Method: MM/DD/YYYY" with one entry per line
          </small>
        </div>

        <div>
          <label htmlFor="next_contact">
            Type of Attempted Contact/Date of Next Attempt:
          </label>
          <textarea
            id="next_contact"
            name="next_contact"
