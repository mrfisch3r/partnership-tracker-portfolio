...
const AddNotPartnershipForm = ({ onPartnerAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('http://localhost:5000/api/add_not_potential_partner', {
        method: 'POST',
        headers: {
    ...
    <div className="add-partner-form">
      ...
      <div className="form-instructions">
        ...
        <ul>
          ...
          <li><strong>Contact Date:</strong> Date of most recent contact (MM/DD/YYYY format)</li>
          <li><strong>Type of Attempted Contact:</strong> Methods used to contact the organization</li>
        </ul>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
          />
          <small className="field-hint">Describe methods used to attempt contact</small>
        </div>
